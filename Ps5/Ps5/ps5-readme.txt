 ...
 **********************************************************************/
I used Hirschberg's algorithm as I felt it would be optimal to my program and plays to my strengths as I am better a iterative programs vs recursive.
...
/**********************************************************************
Yes the memory usage matches the file perfectly
